...
const categoryMeta: Record<BookingCategory, { label: string; icon: typeof Hotel; tone: string }> = {
  HOTEL: { label: "Hotel", icon: Hotel, tone: "bg-cyan-50 text-cyan-700 ring-cyan-200" },
      ...
      <main className="min-h-screen bg-[radial-gradient(circle_at_5%_10%,rgba(14,165,233,0.12),transparent_28%),radial-gradient(circle_at_95%_0%,rgba(99,102,241,0.1),transparent_26%),linear-gradient(180deg,#f8fbff_0%,#f5f7fb_48%,#ffffff_100%)] px-4 py-8 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
            ...
            <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-slate-600 sm:text-base">
                  Track all your hotel stays, tours, rentals, and activities in one clean timeline.
                </p>
              </div>
          ...
          <section className="mt-5 flex flex-wrap gap-2">
            ...
            <BookingFilterButton label="Hotels" active={filter === "HOTEL"} onClick={() => setFilter("HOTEL")} count={counts.HOTEL} />
